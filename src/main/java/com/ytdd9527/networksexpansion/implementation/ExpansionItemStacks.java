...
public class ExpansionItemStacks {
    ...
    public static final SlimefunItemStack NETWORKS_EXPANSION_WORKBENCH = Theme.Random(
            Lang.getItem("NTW_EXPANSION_WORKBENCH", Material.BAMBOO_BLOCK),
            Theme.MACHINE
    );

    public static final SlimefunItemStack NETWORKS_EXPANSION_WORKBENCH_6X6 = Theme.Random(
            Lang.getItem("NTW_EXPANSION_WORKBENCH_6X6", Material.LAPIS_BLOCK),
            Theme.MACHINE
    );
    // Tools
    public static final SlimefunItemStack WORLDEDIT_AXE = Theme.Random(
            Lang.getItem("NTW_EXPANSION_WORLD_EDIT_AXE", Material.DIAMOND_AXE),
            Theme.TOOL
    );
    public static final SlimefunItemStack INFO_TOOL = Theme.Random(
            Lang.getItem("NTW_EXPANSION_INFO_TOOL", Material.FEATHER),
            Theme.TOOL
    );
    // Advanced Networks Machines
    public static final SlimefunItemStack ADVANCED_IMPORT = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_IMPORT", enchanted(Material.RED_STAINED_GLASS)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_EXPORT = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_EXPORT", enchanted(Material.BLUE_STAINED_GLASS)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_PURGER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_PURGER", enchanted(Material.YELLOW_STAINED_GLASS)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_GREEDY_BLOCK = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_GREEDY_BLOCK", enchanted(Material.GRAY_STAINED_GLASS)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack NETWORK_CAPACITOR_5 = Theme.Random(
            Lang.getItem("NTW_EXPANSION_CAPACITOR_5", Material.CYAN_GLAZED_TERRACOTTA),
            Theme.MACHINE
    );
    public static final SlimefunItemStack NETWORK_CAPACITOR_6 = Theme.Random(
            Lang.getItem("NTW_EXPANSION_CAPACITOR_6", Material.BLUE_GLAZED_TERRACOTTA),
            Theme.MACHINE
    );
    public static final SlimefunItemStack NETWORK_INPUT_ONLY_MONITOR = Theme.themedSlimefunItemStack(
            Lang.getItem("NTW_INPUT_ONLY_MONITOR", Material.LIGHT_GRAY_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack NETWORK_OUTPUT_ONLY_MONITOR = Theme.themedSlimefunItemStack(
            Lang.getItem("NTW_OUTPUT_ONLY_MONITOR", Material.GRAY_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PUSHER", Material.OBSERVER),
            Theme.MACHINE
    );

    public static final SlimefunItemStack LINE_TRANSFER_MORE_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_MORE_PUSHER", Material.LIME_GLAZED_TERRACOTTA),
            Theme.MACHINE
    );

    public static final SlimefunItemStack LINE_TRANSFER_BEST_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_BEST_PUSHER", Material.LIME_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_GRABBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_GRABBER", Material.HAY_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER", Material.PISTON),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PLUS_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PLUS_PUSHER", Material.LIME_GLAZED_TERRACOTTA),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PLUS_MORE_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PLUS_MORE_PUSHER", Material.LIME_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PLUS_BEST_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PLUS_BEST_PUSHER", Material.LIME_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PLUS_GRABBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PLUS_GRABBER", Material.WAXED_COPPER_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_PLUS = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_PLUS", Material.STICKY_PISTON),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_VANILLA_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_VANILLA_PUSHER", Material.OBSERVER),
            Theme.MACHINE
    );
    public static final SlimefunItemStack LINE_TRANSFER_VANILLA_GRABBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_LINE_TRANSFER_VANILLA_GRABBER", Material.HAY_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_PUSHER", enchanted(Material.OBSERVER)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_MORE_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_MORE_PUSHER", enchanted(Material.LIME_GLAZED_TERRACOTTA)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_GRABBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_GRABBER", enchanted(Material.HAY_BLOCK)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER", enchanted(Material.PISTON)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_PLUS_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_PLUS_PUSHER", enchanted(Material.LIME_GLAZED_TERRACOTTA)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_PLUS_MORE_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_PLUS_MORE_PUSHER", enchanted(Material.LIME_STAINED_GLASS)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_LINE_TRANSFER_PLUS_BEST_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_LINE_TRANSFER_PLUS_BEST_PUSHER", enchanted(Material.LIME_STAINED_GLASS)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack TRANSFER_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_TRANSFER_PUSHER", Material.OBSERVER),
            Theme.MACHINE
    );
    public static final SlimefunItemStack TRANSFER_MORE_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_TRANSFER_MORE_PUSHER", Material.LIME_GLAZED_TERRACOTTA),
            Theme.MACHINE
    );
    public static final SlimefunItemStack TRANSFER_BEST_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_TRANSFER_BEST_PUSHER", Material.LIME_STAINED_GLASS),
            Theme.MACHINE
    );
    public static final SlimefunItemStack TRANSFER_GRABBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_TRANSFER_GRABBER", Material.HAY_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack TRANSFER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_TRANSFER", Material.PISTON),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_TRANSFER_PUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_TRANSFER_PUSHER", Material.OBSERVER),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack AUTO_EXPANSION_WORKBENCH = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_EXPANSION_WORKBENCH", Material.FIRE_CORAL_BLOCK),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack AUTO_COMPRESSOR = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_COMPRESSOR", Material.COMPOSTER),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_COMPRESSOR_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_COMPRESSOR_WITHHOLDING", Material.JUKEBOX),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_GRIND_STONE = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_GRIND_STONE", Material.DROPPER),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_GRIND_STONE_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_GRIND_STONE_WITHHOLDING", Material.DISPENSER),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_JUICER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_JUICER", Material.MOSS_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_JUICER_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_JUICER_WITHHOLDING", Material.MUD),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_ORE_CRUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_ORE_CRUSHER", Material.RAW_IRON_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_ORE_CRUSHER_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_ORE_CRUSHER_WITHHOLDING", Material.RAW_GOLD_BLOCK),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_PRESSURE_CHAMBER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_PRESSURE_CHAMBER", Material.SMOOTH_STONE),
            Theme.MACHINE
    );
    public static final SlimefunItemStack AUTO_PRESSURE_CHAMBER_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_AUTO_PRESSURE_CHAMBER_WITHHOLDING", Material.SMOOTH_SANDSTONE),
            Theme.MACHINE
    );
    // Advanced Auto Crafters
    public static final SlimefunItemStack ADVANCED_AUTO_MAGIC_WORKBENCH = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_MAGIC_WORKBENCH", enchanted(Material.BOOKSHELF)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_MAGIC_WORKBENCH_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_MAGIC_WORKBENCH_WITHHOLDING", enchanted(Material.CHISELED_BOOKSHELF)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_ARMOR_FORGE = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_ARMOR_FORGE", enchanted(Material.SMITHING_TABLE)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_SMELTERY = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_SMELTERY", enchanted(Material.FURNACE)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_QUANTUM_WORKBENCH_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_QUANTUM_WORKBENCH_WITHHOLDING", enchanted(Material.DRIED_KELP_BLOCK)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_ANCIENT_ALTAR_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_ANCIENT_ALTAR_WITHHOLDING", enchanted(Material.CALIBRATED_SCULK_SENSOR)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_EXPANSION_WORKBENCH_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_EXPANSION_WORKBENCH_WITHHOLDING", enchanted(Material.HORN_CORAL_BLOCK)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_COMPRESSOR = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_COMPRESSOR", enchanted(Material.COMPOSTER)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_GRIND_STONE = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_GRIND_STONE", enchanted(Material.DROPPER)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_JUICER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_JUICER", enchanted(Material.MOSS_BLOCK)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_JUICER_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_JUICER_WITHHOLDING", enchanted(Material.MUD)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_ORE_CRUSHER = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_ORE_CRUSHER", enchanted(Material.RAW_IRON_BLOCK)),
            Theme.MACHINE
    );
    ...
    public static final SlimefunItemStack ADVANCED_AUTO_PRESSURE_CHAMBER_WITHHOLDING = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_PRESSURE_CHAMBER_WITHHOLDING", enchanted(Material.SMOOTH_SANDSTONE)),
            Theme.MACHINE
    );
    public static final SlimefunItemStack ADVANCED_AUTO_CRAFTING_TABLE = Theme.Random(
            Lang.getItem("NTW_EXPANSION_ADVANCED_AUTO_CRAFTING", enchanted(Material.CRAFTING_TABLE)),
            Theme.MACHINE
    );
