...
public class AdvancedLineTransferMorePusher extends AbstractTransfer implements SoftCellBannable, PushTickOnly {
    public AdvancedLineTransferMorePusher(
    ...
    public @NotNull TransferType getTransferType() {
        return TransferType.ADVANCED_LINE_TRANSFER_MORE_PUSHER;
    }
}
