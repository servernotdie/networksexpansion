...
public class AdvancedLineTransferBestPusher extends AbstractTransfer implements SoftCellBannable, PushTickOnly {
    ...
    public @NotNull TransferType getTransferType() {
        return TransferType.ADVANCED_LINE_TRANSFER_BEST_PUSHER;
    }
}
