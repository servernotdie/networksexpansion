...
public class TransferMorePusher extends AbstractTransfer implements SoftCellBannable, PushTickOnly {
    public TransferMorePusher(
    ...
    public @NotNull TransferType getTransferType() {
        return TransferType.TRANSFER_MORE_PUSHER;
    }
}
