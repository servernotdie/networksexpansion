package com.ytdd9527.networks.expansion.utils.databases;
...
public class DataTables {
    ...
    public static final String CONTAINER_CREATION =
            "CREATE TABLE IF NOT EXISTS Container (" +
                    "ContainerID CHAR(8) PRIMARY KEY NOT NULL," +
    ...
    public static final String ITEM_STORED_CREATION =
            "CREATE TABLE IF NOT EXISTS ItemStored (" +
                    "ContainerID CHAR(8) NOT NULL," +
                    "ItemID CHAR(8) NOT NULL," +
                    "Amount CHAR(8) NOT NULL);";

    public static final String ENVIRONMENT_CREATION =
            "CREATE TABLE IF NOT EXISTS Environment (" +
                    "VarName CHAR(8) PRIMARY KEY NOT NULL," +
                    "VarValue CHAR(128) NOT NULL);";
