...
public class ExpansionItemStacks {
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_1 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.TINY.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.TINY.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_2 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.MINI.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.MINI.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_3 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.SMALL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.SMALL.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_4 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.MEDIUM.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.MEDIUM.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_5 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.LARGE.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.LARGE.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_6 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ENHANCED.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ENHANCED.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_7 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ADVANCED.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ADVANCED.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_8 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.EXTRA.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.EXTRA.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_9 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ULTRA.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ULTRA.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_10 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_BASIC.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_BASIC.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_11 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_INTERMEDIATE.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_INTERMEDIATE.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    public static SlimefunItemStack CARGO_STORAGE_UNIT_12 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_ADVANCED.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_ADVANCED.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_13 = Theme.Random(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_MAX.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_MAX.getMaxItemCount() + " 个",
            "",
            thanks,
            ""
    );
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_1_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.TINY_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.TINY_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_2_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.MINI_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.MINI_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_3_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.SMALL_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.SMALL_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_4_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.MEDIUM_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.MEDIUM_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_5_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.LARGE_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.LARGE_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_6_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ENHANCED_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ENHANCED_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_7_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ADVANCED_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ADVANCED_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_8_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.EXTRA_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.EXTRA_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_9_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.ULTRA_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.ULTRA_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_10_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_BASIC_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_BASIC_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_11_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_INTERMEDIATE_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_INTERMEDIATE_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_12_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_ADVANCED_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_ADVANCED_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
    ...
    public static SlimefunItemStack CARGO_STORAGE_UNIT_13_MODEL = Theme.model(
            ...
            "&6支持网络快速输入/输出",
            "",
            "&7⇨ &e可储存 " + StorageUnitType.END_GAME_MAX_MODEL.getEachMaxSize() + " 种物品",
            "&7⇨ &e每种物品可容纳 " + StorageUnitType.END_GAME_MAX_MODEL.getMaxItemCount() + " 个",
            "",
            "&7⇨ &e需要网络扳手才能拆除模型方块",
            "",
            thanks,
