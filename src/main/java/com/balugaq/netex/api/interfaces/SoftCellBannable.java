...
public interface SoftCellBannable extends FeedbackSendable {
    ...
    default boolean checkSoftCellBan(BlockMenu blockMenu, NodeDefinition definition) {
        return checkSoftCellBan(blockMenu.getLocation(), definition);
    }

    default boolean checkSoftCellBan(BlockMenu blockMenu, NetworkRoot root) {
        return checkSoftCellBan(blockMenu.getLocation(), root);
    }

    default boolean checkSoftCellBan(Location location, NodeDefinition definition) {
    ...
    default boolean checkSoftCellBan(Location location, NetworkRoot root) {
